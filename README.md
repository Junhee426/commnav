...
**궤도면 수**와 **궤도면당 위성 수**를 각각 입력해 위성군을 구성합니다. 예를 들어 7면 × 12기는 총 84기입니다. 총 512기를 초과하거나 정수가 아닌 값을 입력하면 오류를 표시하고 마지막 유효 설정을 유지합니다. 기본값은 기존과 같은 16면 × 16기이며, 원궤도·구형 지구·Walker Delta F=1 가정도 동일합니다.
